...
@objc open class AllShortcutsViewController: UITableViewController, ShortcutsManagerDelegate, AllShortcutsViewControllerDataSourceDelegate {
...
//        let next = storyboard.instantiateViewController(withIdentifier: "TimerViewController") as! TimerViewController
